...
namespace Microsoft.AspNet.OData
{
    ...
    public sealed partial class DynamicODataQueryParameterBindingAttribute : ParameterBindingAttribute
    {
        /// <inheritdoc />
        public override HttpParameterBinding GetBinding(HttpParameterDescriptor parameter)
        {
            return new DynamicODataQueryParameterBinding(parameter);
        }

        internal class DynamicODataQueryParameterBinding : HttpParameterBinding
        {
            private static MethodInfo _createODataQueryOptions = typeof(DynamicODataQueryParameterBinding).GetMethod("CreateDynamicODataQueryOptions");
            private const string CreateODataQueryOptionsCtorKey = "MS_CreateDynamicODataQueryOptions";

            public DynamicODataQueryParameterBinding(HttpParameterDescriptor parameterDescriptor)
            ...
            public override Task ExecuteBindingAsync(ModelMetadataProvider metadataProvider, HttpActionContext actionContext, CancellationToken cancellationToken)
            {
                ...
                Func<HttpRequestMessage, DynamicODataQueryOptions> createODataQueryOptions =
                    ...
                    {
                        return Delegate.CreateDelegate(typeof(Func<HttpRequestMessage, DynamicODataQueryOptions>), _createODataQueryOptions.MakeGenericMethod());
                    });

                DynamicODataQueryOptions parameterValue = createODataQueryOptions(request);
